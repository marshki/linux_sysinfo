...
This script builds on, and improves ~~grabsysinfo.sh~~ attributed to Vivek Gite circa 12/Sep/2007. 

Tested to run in: Centos 7, Debian 8 & Ubuntu 16.04, though it should work on other distros as well. 
